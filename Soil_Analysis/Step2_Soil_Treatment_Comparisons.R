...
leave.out = c("texture.class","volumetric.moisture","h.meq","elevation.mean",
              "vegetation.height.mean","fpom")
...
select.vars = c("tic.percent","maoc.percent","toc.percent","bulk.c.percent")
#for (i in 1:n.v) { 
#  v.i = vars[i]
for (i in 1:4) {  
  v.i = select.vars[i]
